...
Enter the total no. of nodes in btree : 3

Enter the data field of node 1 : 6

Enter the data field of node 2 : 4

Where to add (l/r) of 6 : l

Enter the data field of node 3 : 8

Where to add (l/r) of 6 : r
...
Enter ur choice : 2
Inorder Traversal of the tree : 4  6  8  
	1: Create Binary Tree
	2: Display Binary Tree
	3: Thread the Tree 
	4: Display the threaded tree
...
Enter ur choice : 4
Preorder Traversal of the tree : 6 4 8 
	1: Create Binary Tree
	2: Display Binary Tree
	3: Thread the Tree 
	4: Display the threaded tree
